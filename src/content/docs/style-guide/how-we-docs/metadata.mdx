...
For example, here's the content from our [DNS folder](https://github.com/cloudflare/cloudflare-docs/blob/production/src/content/directory/dns.yaml).

<GitHubCode
	repo="cloudflare/cloudflare-docs"
	file="src/content/directory/dns.yaml"
