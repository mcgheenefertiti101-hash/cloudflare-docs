...
export const learningPathsSchema = z
	.object({
		...
		products: z
			...
			.default([])
			.describe(
				"The names of related products (according to their file name in `src/content/directory`). Usually, these correspond to file paths, but not always, such as with `cloudflare-tunnel`",
			),
