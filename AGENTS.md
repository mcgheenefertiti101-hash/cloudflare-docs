...
│   │   ├── directory/      # Product/feature directory metadata (YAML)
...
10. **Invalid changelog product folders** — the product directory must exist in `src/content/directory/`.
...
| `directory`         | `src/content/directory/`         | Product metadata (YAML)                 |
